...
public class PrimitiveDataTypesIntro {
    public static void main(String[] args) {
        ...
        int s = 95000; // preferred dataType

        System.out.println(s);

        // int n = 9999999999;
        long n = 9999999999L; // Manually enter (l or L) to compile large numbers
        ...
        float gpa2 = 3.5F; // Manually enter (f or F) to compile low/higher decimals
